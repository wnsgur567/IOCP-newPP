...
namespace NetCipher
{
	...
	constexpr auto NoRounds = 16;					// the number of rounds;
	constexpr auto NoRoundKeys = (NoRounds * 2);	// the number of round-keys		
	constexpr auto SeedBlockSize = 16;				// block length in bytes;
	constexpr auto SeedBlockLen = 128;				// block length in bits;
