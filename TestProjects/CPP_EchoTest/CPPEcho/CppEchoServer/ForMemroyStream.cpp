...
namespace Utils
{
	...
	void NewFloatingTest()
	{
		...
		int write_size = Utils::WriteToBinStreamImpl(output_buffer, 0.f);
		...
		{
			output_buffer->Clear();
			write_size = Utils::WriteToBinStreamImpl(output_buffer, c[i]);

			input_buffer->Clear();
			memcpy(input_buffer->GetBufferPtr(), output_buffer->GetBufferPtr(), 512);
			float_t b;
			int read_size = Utils::ReadFromBinStreamImpl(input_buffer, b);
	...
	void NewVectorTest()
	{
		...
		output_buffer->Clear();
		write_size = Utils::WriteToBinStreamImpl(output_buffer, integer_vec);

		input_buffer->Clear();
		memcpy(input_buffer->GetBufferPtr(), output_buffer->GetBufferPtr(), 512);

		std::vector<int> input_vec;
		read_size = Utils::ReadFromBinStreamImpl(input_buffer, input_vec);
		...
		output_buffer->Clear();
		write_size = Utils::WriteToBinStreamImpl(output_buffer, uinteger_vec);

		input_buffer->Clear();
		memcpy(input_buffer->GetBufferPtr(), output_buffer->GetBufferPtr(), 512);
		std::vector<uint64_t > uinput_vec;
		read_size = Utils::ReadFromBinStreamImpl(input_buffer, uinput_vec);
		...
		output_buffer->Clear();
		write_size = Utils::WriteToBinStreamImpl(output_buffer, float_vec);

		input_buffer->Clear();
		memcpy(input_buffer->GetBufferPtr(), output_buffer->GetBufferPtr(), 512);
		std::vector<float> finput_vec;
		read_size = Utils::ReadFromBinStreamImpl(input_buffer, finput_vec);
		...
		output_buffer->Clear();
		write_size = Utils::WriteToBinStreamImpl(output_buffer, double_vec);

		input_buffer->Clear();
		memcpy(input_buffer->GetBufferPtr(), output_buffer->GetBufferPtr(), 512);

		std::vector<double> dinput_vec;
		read_size = Utils::ReadFromBinStreamImpl(input_buffer, dinput_vec);
		...
		output_buffer->Clear();
		write_size = Utils::WriteToBinStreamImpl(output_buffer, string_vec);

		input_buffer->Clear();
		memcpy(input_buffer->GetBufferPtr(), output_buffer->GetBufferPtr(), 512);
		std::vector<std::string> stringInput_vec;
		read_size = Utils::ReadFromBinStreamImpl(input_buffer, stringInput_vec);
	...
	void NewMapTest()
	{
		...
		output_buffer->Clear();
		write_size = Utils::WriteToBinStreamImpl(output_buffer, integer_to_string_map);

		input_buffer->Clear();
		memcpy(input_buffer->GetBufferPtr(), output_buffer->GetBufferPtr(), 512);
		std::map<int, std::string> integer_to_string_inputmap;
		read_size = Utils::ReadFromBinStreamImpl(input_buffer, integer_to_string_inputmap);
