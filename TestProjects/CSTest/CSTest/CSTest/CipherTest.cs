...
0xc9d1d819, 0x4c404c0c, 0x83838003, 0x8f838c0f, 0xcec2cc0e, 0x0b33383b, 0x4a42480a, 0x87b3b437
        ...
        /// </summary>
        /// <param name="L0"> left input values at each round </param>
        /// <param name="L1"> left input values at each round </param>
        ...
        //public static void RoundKeyUpdate1(ref DWORD T0, ref DWORD T1,
        //    ref DWORD[] K, ref DWORD A, ref DWORD B, ref DWORD C, ref DWORD D, DWORD KC)
        //{
        //    T0 = A + C - KC;
        //    T1 = B + KC - D;
    ...
    class CipherTest
    {
        ...
        public unsafe static void SEED_KeySchedKey(_DWORD[] pbUserKey, _DWORD[] pdwRoundKey)
        {
            ...
            K[30] = CipherMacro.SS0[CipherMacro.GetB0(T0)] ^ CipherMacro.SS1[CipherMacro.GetB1(T0)] ^   // K_16,0
                CipherMacro.SS2[CipherMacro.GetB2(T0)] ^ CipherMacro.SS3[CipherMacro.GetB3(T0)];
            K[31] = CipherMacro.SS0[CipherMacro.GetB0(T1)] ^ CipherMacro.SS1[CipherMacro.GetB1(T1)] ^   // K_16,1
                CipherMacro.SS2[CipherMacro.GetB2(T1)] ^ CipherMacro.SS3[CipherMacro.GetB3(T1)];
        }
    }
}
